...
Part 2:  Find your seat - the flight is full, but some of the seats
in the front and the back don't exist!
But seats with IDs +1 and -1 will be in the list
'''
import math
...
for binaryBoardingPass in input:
    ...
    seatIds.append(currentSeatId)
    
for number in range(minSeatId, maxSeatId + 1):
    if number not in seatIds:
        print(f'Missing Seat: {number}')
